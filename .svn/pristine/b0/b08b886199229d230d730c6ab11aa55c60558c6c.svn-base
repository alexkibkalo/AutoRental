...
public class UnlockUser extends HttpServlet{
    ...
    private static final Logger logger = LoggerFactory.getLogger(UnlockUser.class);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        new UserDaoImpl().statusUpdate("unlocked", username);

        logger.info("The administrator has unblocked the user " + username + ".");
